 ...
 * [ListaCarrosFragment.OnFragmentInteractionListener] interface
...
class ListaCarrosFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ListaCarrosFragment {
            val fragment = ListaCarrosFragment()
            val args = Bundle()
